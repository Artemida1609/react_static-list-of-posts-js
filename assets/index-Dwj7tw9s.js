...
aut aut aut maxime quia temporibus ut omnis`}];function Lc(e){return Pc.filter(t=>t.postId===e)}const Tc=({post:e})=>{const t=Lc(e.id)||[];return O.jsxs("div",{className:"PostInfo",children:[O.jsxs("div",{className:"PostInfo__header",children:[O.jsx("h3",{className:"PostInfo__title",children:e.title}),O.jsxs("p",{children:[" Posted by  ",e.user&&O.jsx(Cc,{user:e.user})]})]}),O.jsx("p",{className:"PostInfo__body",children:e.body}),O.jsx("hr",{}),t.length>0?O.jsx(Nc,{comments:t}):O.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"})]})},Mc=({posts:e})=>O.jsx("div",{className:"PostList",children:e.map(t=>O.jsx(Tc,{post:t},t.id))}),Rc=[{id:1,userId:1,title:"sunt aut facere repellat provident occaecati excepturi optio reprehenderit",body:`quia et suscipit
...
expedita consequatur consequatur dolores quia eos et placeat`}],Dc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}];function jc(e){return Dc.find(t=>t.id===e)||null}const Oc=Rc.map(e=>({...e,user:jc(e.userId)})),Fc=()=>O.jsxs("section",{className:"App",children:[O.jsx("h1",{className:"App__title",children:"Static list of posts"}),O.jsx(Mc,{posts:Oc})]});em(document.getElementById("root")).render(O.jsx(Fc,{}));
